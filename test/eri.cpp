...
#define DEBUG 0
#if DEBUG
  LIBINT2_REF_REALTYPE Wx,Wy,Wz;
  LIBINT2_REF_REALTYPE WPx,WPy,WPz;
  LIBINT2_REF_REALTYPE WQx,WQy,WQz;
  Wx = Px*gammap/(gammap+gammaq) + Qx*gammaq/(gammap+gammaq);
  Wy = Py*gammap/(gammap+gammaq) + Qy*gammaq/(gammap+gammaq);
  Wz = Pz*gammap/(gammap+gammaq) + Qz*gammaq/(gammap+gammaq);
  WPx = Wx - Px;
  WPy = Wy - Py;
  WPz = Wz - Pz;
  WQx = Wx - Qx;
  ...
  std::cout << "exponents " << alpha1 << " " << alpha2 << " "<< 
	  alpha3 << " " << alpha4 << std::endl;
  std::cout << "QC " << QCx  << " " << QCy << " " << QCz << std::endl;
  std::cout << "WP " << WPx  << " " << WPy << " " << WPz << std::endl;
  std::cout << "WQ " << WQx  << " " << WQy << " " << WQz << std::endl;
  std::cout << "W " << Wx  << " " << Wy << " " << Wz << std::endl;
  std::cout << "P " << Px  << " " << Py << " " << Pz << std::endl;
  std::cout << "Q " << Qx  << " " << Qy << " " << Qz << std::endl;
  std::cout << "kappa "  << gammap/gammapq << " " << gammaq/gammapq << std::endl;
