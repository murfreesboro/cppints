...
namespace nai {
	...
	/**
	 * This function is used to calculate the NAI 
	 ...
	 */
	void directnai(const Int& Li, const Int& Lj, const Int& natoms, 
	 ...
	 */
	void nai_test(const Int& maxL,const Int& inp,const vector<Double>& icoe, 
